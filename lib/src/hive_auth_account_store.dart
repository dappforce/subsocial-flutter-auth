...
/// [HiveAuthAccountStore] stores accounts and the current active account on disk using [Hive].
class HiveAuthAccountStore extends ChangeNotifier implements AuthAccountStore {
  final Completer<Box<AuthAccount>> _authAccountBoxCompleter = Completer();
  final SharedPreferences _sharedPreferences;

  /// Creates [HiveAuthAccountStore]. Make sure to initialize hive before calling.
  HiveAuthAccountStore(String boxName, this._sharedPreferences) {
